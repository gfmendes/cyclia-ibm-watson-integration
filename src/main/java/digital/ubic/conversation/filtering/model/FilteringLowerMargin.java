...
public class FilteringLowerMargin implements FilteringType {

    public static final String  TYPE = "lower_margin";

    private String name;
    private String margin;
    private String weight;

    public FilteringLowerMargin(String name, String margin, String weight) {
        this.name = name;
        this.margin = margin;
        this.weight = weight;
    }
    ...
    public Double calculate(String productValue, String userValue) {
        ...
        Double calc = (answer <= min) ? 1 * getWeight() : 0;
